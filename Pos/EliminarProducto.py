...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label_4.setGeometry(QtCore.QRect(50, 100, 61, 41))
        font = QtGui.QFont()
        font.setFamily("Bahnschrift Condensed")
        self.label_4.setFont(font)
        self.label_4.setObjectName("label_4")
        self.agregar = QtWidgets.QPushButton(self.centralwidget)
        self.agregar.setGeometry(QtCore.QRect(440, 130, 141, 41))
        font = QtGui.QFont()
        font.setFamily("Bahnschrift Condensed")
...
"font: 16pt \"Bahnschrift Condensed\";")
        ...
        self.ID.setGeometry(QtCore.QRect(130, 100, 191, 41))
        self.ID.setStyleSheet("background-color: rgb(255, 255, 255);")
        self.ID.setObjectName("ID")
        self.nombre = QtWidgets.QTextEdit(self.centralwidget)
        self.nombre.setGeometry(QtCore.QRect(130, 160, 191, 41))
        self.nombre.setStyleSheet("background-color: rgb(255, 255, 255);")
        self.nombre.setObjectName("nombre")
        self.tableView = QtWidgets.QTableView(self.centralwidget)
        self.tableView.setGeometry(QtCore.QRect(90, 290, 651, 192))
        ...
        self.eliminar.setGeometry(QtCore.QRect(450, 510, 141, 41))
        font = QtGui.QFont()
        font.setFamily("Bahnschrift Condensed")
        font.setPointSize(16)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label.setText(_translate("MainWindow", "<html><head/><body><p>Eliminar Producto</p></body></html>"))
        self.eliminar.setText(_translate("MainWindow", "Eliminar"))
import logoeliminarproducto_rc
